...
class Kohana_HTMLTest extends Unittest_TestCase
{
	...
	public function provider_script()
	{
		return array(
			array(
				'<script type="text/javascript" html="http://google.com/script.js"></script>',
				'http://google.com/script.js',
			),
			array(
				'<script type="text/javascript" html="http://www.kohanaframework.org/kohana/index.php/my/script.js"></script>',
				'my/script.js',
				NULL,
				'http',
				TRUE
			...
			array(
				'<script type="text/javascript" html="https://www.kohanaframework.org/kohana/my/script.js"></script>',
				'my/script.js',
				NULL,
				'https',
				FALSE
			...
			array(
				'<script type="text/javascript" html="//google.com/script.js"></script>',
